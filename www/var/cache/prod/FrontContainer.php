...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', '/var/www/html', false);
    }
    ...
    {
        return $container->services['PrestaShop\\Module\\PrestashopCheckout\\Logger\\LoggerDirectory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('9.0.0', '/var/www/html');
    }
    ...
    {
        return $container->services['ps_checkout.cache.filesystem.paypal.capture'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-capture', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', '/var/www/html', false))->getPath());
    }
    ...
    {
        return $container->services['ps_checkout.cache.filesystem.paypal.order'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-orders', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', '/var/www/html', false))->getPath());
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['/var/www/html/src/PrestaShopBundle/Entity']), 'PrestaShop');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['/var/www/html/modules/ps_checkout/src/Entity']), 'PrestaShop\\Module\\PrestashopCheckout\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['/var/www/html/modules/ps_accounts/src/Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['/var/www/html/modules/productcomments/src/Entity']), 'PrestaShop\\Module\\ProductComment\\Entity');
        ...
        $instance->setProxyDir('/var/www/html/var/cache/prod//doctrine/orm/Proxies');
