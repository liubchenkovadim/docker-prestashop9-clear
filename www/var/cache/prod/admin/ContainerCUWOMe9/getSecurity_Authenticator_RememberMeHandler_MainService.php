...
class getSecurity_Authenticator_RememberMeHandler_MainService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authenticator.remember_me_handler.main'] = new \Symfony\Component\Security\Http\RememberMe\SignatureRememberMeHandler(new \Symfony\Component\Security\Core\Signature\SignatureHasher(($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)), ['password'], 'nIUB5vCHK2TYIB2YxWgu4dZgWuPmwIR7E1us219CEEKjhSV0q43Tpo3Oabcn3QyZ', NULL, NULL), $a, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ['secret' => 'nIUB5vCHK2TYIB2YxWgu4dZgWuPmwIR7E1us219CEEKjhSV0q43Tpo3Oabcn3QyZ', 'lifetime' => 1728000, 'remember_me_parameter' => 'stay_logged_in', 'signature_properties' => ['password'], 'user_providers' => [], 'catch_exceptions' => true, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => NULL, 'httponly' => true, 'samesite' => NULL, 'always_remember_me' => false], ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)));
    }
}
