...
class get_UxIcons_CacheIconRegistryService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->privates['.ux_icons.cache_icon_registry'] = new \Symfony\UX\Icons\Registry\CacheIconRegistry(new \Symfony\UX\Icons\Registry\ChainIconRegistry(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.ux_icons.local_svg_icon_registry'] ??= new \Symfony\UX\Icons\Registry\LocalSvgIconRegistry((\dirname(__DIR__, 5).'/admin998pvkwthfbjs4fkedt/themes/new-theme/icons'), []));
